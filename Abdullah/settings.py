"""
Django settings for Abdullah project.
...
SECRET_KEY = 'django-insecure-p3o%nfm9(=p%ro--xkoqsas@pznc1-8i33z-szohx+*u0y41pn'
...
WSGI_APPLICATION = 'Abdullah.wsgi.application'
